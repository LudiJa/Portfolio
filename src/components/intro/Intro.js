        ...
        <div className="row">
          <div className=" col-12 col-sm-10">
            ...
            <p>
              ...
              mobile.
              <p>
                Motivée, curieuse, passionnée, je serai une stagiaire idéale si
                vous acceptez de travailler avec moi à partir du 10 janvier
                2022, pour une période allant de 2 à 6 mois, et pourquoi pas
                pour plus longtemps par la suite ! Actuellement en formation et
                travaillant sur des projets personnels avec React, SQL et
